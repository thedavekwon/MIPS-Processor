...
HD_PWD='/afs/ee.cooper.edu/user/k/kwon3/Projects/MIPS-Processor/Midterm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PIPEDPROCESSOR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PIPEDPROCESSOR.tcl -notrace
